...
<div class="form-group {{ $errors->has('identificador') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="identificador" type="text" oninput="this.value = this.value.toUpperCase()"
        id="identificador" value="{{ isset($propietario->identificador) ? $propietario->identificador : '' }}">
...
<div class="form-group {{ $errors->has('idBaseOperativa') ? 'has-error' : '' }}">
    <div class="form-group {{ $errors->has('matricula') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="matricula" type="text" oninput="this.value = this.value.toUpperCase()"
            id="matricula" value="{{ isset($artefacto->matricula) ? $artefacto->matricula : '' }}">
    ...
    <div class="form-group {{ $errors->has('nombreA') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="nombreA" type="text" oninput="this.value = this.value.toUpperCase()"
            id="nombreA" value="{{ isset($artefacto->nombre) ? $artefacto->nombre : '' }}">
        ...
        <tr>
            <td>
                <div class="form-group {{ $errors->has('eslora') ? 'has-error' : '' }}">
                    ...
                    <input name="eslora" class="form-control" type="text" id="eslora"
                        oninput="handleDecimalInput()" required
            ...
            <td>
                <div class="form-group {{ $errors->has('manga') ? 'has-error' : '' }}">
                    ...
                    <input name="manga" class="form-control" type="text" id="manga"
                        oninput="handleDecimalInput()" inputmode="number" required
            ...
            <td>
                <div class="form-group {{ $errors->has('trn') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control" name="trn" type="text" id="trn"
                        oninput="handleDecimalInput()" inputmode="number" required
        ...
        <tr>
            <td>
                <div class="form-group {{ $errors->has('puntal') ? 'has-error' : '' }}">
                    ...
                    <input name="puntal" class="form-control" type="text" id="puntal"
                        oninput="handleDecimalInput()" inputmode="number" required
            ...
            <td>
                <div class="form-group {{ $errors->has('francobordo') ? 'has-error' : '' }}">
                    ...
                    <input name="francobordo" class="form-control" type="text" id="francobordo"
                        oninput="handleDecimalInput()" inputmode="number" required
            ...
            <td>
                <div class="form-group {{ $errors->has('trb') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control" name="trb" type="text" id="trb"
                        oninput="handleDecimalInput()" inputmode="number" required
    ...
    <div class="form-group {{ $errors->has('construccion') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="construccion" type="text"
            oninput="this.value = this.value.toUpperCase()" id="construccion"
    ...
    <div class="form-group {{ $errors->has('tipoM') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="tipoM" type="text" oninput="this.value = this.value.toUpperCase()"
            id="tipoM" value="{{ isset($motore->tipo) ? $motore->tipo : '' }}">
        {!! $errors->first('tipoM', '<p class="help-block">:message</p>') !!}
    </div>
    <div class="form-group {{ $errors->has('marca') ? 'has-error' : '' }}">
        <label for="marca" class="control-label">{{ 'Marca del motor' }}</label>
        <input class="form-control" name="marca" type="text" oninput="this.value = this.value.toUpperCase()"
            id="marca" value="{{ isset($motore->marca) ? $motore->marca : '' }}">
        {!! $errors->first('marca', '<p class="help-block">:message</p>') !!}
    </div>
    <div class="form-group {{ $errors->has('numero') ? 'has-error' : '' }}">
        <label for="numero" class="control-label">{{ 'Numero del motor' }}</label>
        <input class="form-control" name="numero" type="text" oninput="this.value = this.value.toUpperCase()"
            id="numero" value="{{ isset($motore->numero) ? $motore->numero : '' }}">
        {!! $errors->first('numero', '<p class="help-block">:message</p>') !!}
    </div>
    <div class="form-group {{ $errors->has('potencia') ? 'has-error' : '' }}">
        <label for="potencia" class="control-label">{{ 'Potencia HP' }}</label>
        <input class="form-control" name="potencia" type="text" oninput="this.value = this.value.toUpperCase()"
            id="potencia" value="{{ isset($motore->potencia) ? $motore->potencia : '' }}">
    ...
    <div class="form-group {{ $errors->has('nominalelectrica') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="nominalelectrica" type="text"
            oninput="this.value = this.value.toUpperCase()" id="nominalelectrica"
    ...
    <div class="form-group {{ $errors->has('gestion') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="gestion" type="text" oninput="this.value = this.value.toUpperCase()"
            id="gestion" value="{{ isset($inspeccione->gestion) ? $inspeccione->gestion : '' }}">
    ...
    <div class="form-group {{ $errors->has('jefeinspector') ? 'has-error' : '' }}">
        ...
        <input class="form-control" name="jefeinspector" type="text"
            oninput="this.value = this.value.toUpperCase()" id="jefeinspector"

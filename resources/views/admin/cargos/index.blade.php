        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/cargos/create') }}" class="btn btn-success btn-sm" title="Add New cargo">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Cargo</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($cargos as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->cargo }}</td>
                                        <td>
                                            <a href="{{ url('/admin/cargos/' . $item->id) }}" title="View cargo"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/cargos/' . $item->id . '/edit') }}" title="Edit cargo"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

          ...
          <div class="col-md-9">
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <a href="{{ url('/admin/material/' . $material->id . '/edit') }}" title="Editar Material"><button
                              class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                              Editar</button></a>

                      <form method="POST" action="{{ url('admin/material' . '/' . $material->id) }}"
                          accept-charset="UTF-8" style="display:inline">
                          {{ method_field('DELETE') }}
                          {{ csrf_field() }}
                          <button type="submit" class="btn btn-danger btn-sm" title="Borrar Material"

<div class="form-group {{ $errors->has('idUsuario') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="idUsuario" type="number" id="idUsuario"
        value="{{ isset($ubicacion->idUsuario) ? $ubicacion->idUsuario : '' }}">
...
<div class="form-group {{ $errors->has('idCuenca') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="idCuenca" type="number" id="idCuenca"
        value="{{ isset($ubicacion->idCuenca) ? $ubicacion->idCuenca : '' }}">
    {!! $errors->first('idCuenca', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('idBaseOperativa') ? 'has-error' : '' }}">
    <label for="idBaseOperativa" class="control-label">{{ 'BASE DE OPERACIONES' }}</label>
    <input class="form-control" name="idBaseOperativa" type="number" id="idBaseOperativa"
        value="{{ isset($ubicacion->idBaseOperativa) ? $ubicacion->idBaseOperativa : '' }}">

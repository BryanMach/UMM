        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/artefactos/create') }}" class="btn btn-success btn-sm" title="Agregar nuevo Artefacto">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Nro</th><th>IdUsuarios</th><th>IdBaseOperativa</th><th>Matricula</th><th>Opciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($artefactos as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/artefactos/' . $item->id) }}" title="Ver Artefacto"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                            <a href="{{ url('/admin/artefactos/' . $item->id . '/edit') }}" title="Editar Artefacto"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr><th>Embarcaciones a su nombre</th></tr>
                                
                                @foreach ($lista as $barco)
                                    <tr>
                                        <th>{{ $barco->artefactos->nombre }} </th>
                                        <td>
                                            <a href="{{ url('/admin/artefactos/' . $barco->idArtefacto) }}">{{ $barco->artefactos->matricula }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

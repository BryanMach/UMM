<div class="form-group {{ $errors->has('idArtefacto') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="idArtefacto" type="number" id="idArtefacto" value="{{ isset($datosadicionale->idArtefacto) ? $datosadicionale->idArtefacto : ''}}" >
    {!! $errors->first('idArtefacto', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('lugar') ? 'has-error' : ''}}">
    <label for="lugar" class="control-label">{{ 'Lugar' }}</label>
    <input class="form-control" name="lugar" type="text" id="lugar" value="{{ isset($datosadicionale->lugar) ? $datosadicionale->lugar : ''}}" >
...
<div class="form-group {{ $errors->has('mercPelig') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="mercPelig" type="text" id="mercPelig" value="{{ isset($datosadicionale->mercPelig) ? $datosadicionale->mercPelig : ''}}" >
...
<div class="form-group {{ $errors->has('maxPasajeros') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="maxPasajeros" type="number" id="maxPasajeros" value="{{ isset($datosadicionale->maxPasajeros) ? $datosadicionale->maxPasajeros : ''}}" >
...
<div class="form-group {{ $errors->has('cargaComb') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cargaComb" type="number" id="cargaComb" value="{{ isset($datosadicionale->cargaComb) ? $datosadicionale->cargaComb : ''}}" >
    {!! $errors->first('cargaComb', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('peso') ? 'has-error' : ''}}">
    <label for="peso" class="control-label">{{ 'Peso' }}</label>
    <input class="form-control" name="peso" type="number" id="peso" value="{{ isset($datosadicionale->peso) ? $datosadicionale->peso : ''}}" >
...
<div class="form-group {{ $errors->has('altura') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="altura" type="number" id="altura" value="{{ isset($datosadicionale->altura) ? $datosadicionale->altura : ''}}" >
